...
input int      InpMaxReversals         = 2;         // Máximo de Reversões
...
int OnInit() {
    ...
    // CONECTAR GERENCIADORES AO PAINEL PARA ESTATÍSTICAS EM TEMPO REAL
    panelMgr.ConnectManagers(&trackingMgr, &reversalMgr);
    if(InpDebugMain) Print("Gerenciadores conectados ao PanelManager - Estatísticas em tempo real ativas");
